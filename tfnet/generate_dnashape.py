...
query_table_original = pd.DataFrame(
    data=dict_with_shapes["data"],
    columns=dict_with_shapes["columns"],
...
def seq_to_shape14(seq, query_table):
    ...
    for index in range(0, len(seq)):
        ...
        if (len(current_pentamer) < 5) or not all(
            ...
            for shape_name in query_table:
                shape_position_value[shape_name][current_position] = query_table.loc[
    ...
    for shape_name in inter_shapes:
        ...
        translation[shape_name] = translation.apply(
            calculate_intershape, args=(shape_name,), axis=1
        )
