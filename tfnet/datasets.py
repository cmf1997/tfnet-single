...
class TFBindDataset(Dataset):
    def __init__(self, data_list, genome_fasta_file, bw_file, DNA_len=1024, DNA_pad=10, tf_len=20, padding_idx=0, target_len=200, DNA_N = True):
        self.DNA_N = DNA_N
    ...
    def __getitem__(self, idx):
        chr, start, stop, bind_list, tf = self.data_list[idx]
